        ...
        <div className="feed-wrapper">
          ...
          {payload && isDark && (
            <div className={`divide-y ${dividerCls}`}>
              <RevealPost isDark tutorialId="tutorial-post">
                <HeroPost
                  activeIndex={heroIndex}
                  isLiked={Boolean(likedPosts.hero)}
                  isReposted={Boolean(repostedPosts.hero)}
                  onComment={() => openCommentSheet("hero")}
                  onLike={() => toggleLiked("hero")}
                  onRepost={() => toggleReposted("hero")}
